...
date=$(date +"%Y-%m-%d")
clear
echo " VPS Data Backup By JengkolOnline "
sleep 1
echo ""
...
clear
echo -e "\033[1;37mVPS Data Backup By JengkolOnline\033[0m
\033[1;37mTelegram : https://t.me/Jengkol_Online / @Jengkol_Online\033[0m"
echo ""
